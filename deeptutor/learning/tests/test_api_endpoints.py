...
class TestProgressBoard:
    def test_board_empty(self, client):
        resp = client.get("/api/v1/learning/progress/boardempty/board")
        assert resp.status_code == 200
        data = resp.json()
    ...
    def test_board_card_shape_and_position(self, client):
        client.post(
            "/api/v1/learning/progress/boardbook/init-modules",
            json={
                "modules": [
                    {
                        "id": "m1",
        ...
        resp = client.get("/api/v1/learning/progress/boardbook/board")
        assert resp.status_code == 200
        data = resp.json()
    ...
    def test_board_invalid_book_id_returns_400(self, client):
        resp = client.get("/api/v1/learning/progress/a\\b/board")
        assert resp.status_code == 400
