...
class KidsBookAssignment(BaseModel):
    """Links a reading document or interactive book to a child profile."""

    id: str
    profile_id: str
    content_type: Literal["reading", "interactive_book"] = "reading"
    document_id: str = ""
    book_id: str = ""
    document_title: str = ""
...
class KidsInteractiveBookProgress(BaseModel):
    """Per-profile per-interactive-book progress, isolated from adult book progress."""
