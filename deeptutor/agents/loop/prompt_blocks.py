...
class LoopPromptAssembler:
    ...
    def __init__(self, *, prompts: dict[str, Any], language: str) -> None:
        ...
        # directive can name. Collapsing them meant a Ukrainian UI was told,
        # in its system prompt, to answer in English.
    ...
    def render(self, blocks: list[PromptBlock]) -> str:
        ...
        return append_language_directive(
            joined, self.output_language, allow_user_override=True
        )
