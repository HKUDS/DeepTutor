...
_CAPABILITY_DESCRIPTIONS: dict[str, dict[str, str]] = {
    "chat": {
        ...
        "es": "Chat inteligente predeterminado con herramientas, recuperación, memoria y adjuntos.",
    },
    "deep_solve": {
        "en": "Multi-step problem solving with planning, reasoning, and final writing.",
        "zh": "多步骤解题，包含规划、推理和最终作答。",
        "es": "Resolución de problemas en varios pasos: planificación, razonamiento y respuesta final.",
    },
    "deep_question": {
        "en": "Generate high-quality questions from templates, sources, or learning goals.",
        "zh": "基于模板、资料或学习目标生成高质量题目。",
        "es": "Genera preguntas de calidad a partir de plantillas, fuentes u objetivos de aprendizaje.",
    },
    "deep_research": {
        "en": "Iterative deep research that decomposes a topic and writes a report.",
        "zh": "迭代式深度研究，分解主题并生成研究报告。",
        "es": "Investigación profunda iterativa que descompone un tema y redacta un informe.",
    },
    "math_animator": {
        "en": "Generate math animations or storyboard images with Manim.",
        "zh": "使用 Manim 生成数学动画或分镜图。",
        "es": "Genera animaciones matemáticas o guiones gráficos con Manim.",
    },
    "mastery_path": {
    ...
    "visualize": {
        ...
        "es": "Crea explicaciones visuales en SVG, gráficos, Mermaid, HTML o Manim.",
    },
    "immersive_reading": {
        "en": "Read a document with the assistant, cited page by page.",
        "zh": "与助手一起阅读文档，逐页标明出处。",
        "es": "Lee un documento con el asistente, con citas página a página.",
    },
}
...
_TOOL_DESCRIPTIONS: dict[str, dict[str, str]] = {
    "brainstorm": {
        ...
        "zh": "广泛发散想法，并按理由组织结果。",
        "es": "Explora ideas con amplitud y organízalas con su justificación.",
    },
    "exec": {
        "en": "Run source code or shell scripts inside an isolated workspace.",
        "zh": "在隔离工作区中运行源码或 shell 脚本。",
        "es": "Ejecuta código fuente o scripts de terminal en un espacio de trabajo aislado.",
    },
    "kb_files": {
        "en": "List the documents a knowledge base holds, with the total count.",
        "zh": "列出知识库中的文档清单与总数。",
        "es": "Enumera los documentos de una base de conocimiento y su número total.",
    },
    "paper_search": {
        "en": "Search arXiv preprints and return paper metadata.",
        "zh": "搜索 arXiv 预印本并返回论文元数据。",
        "es": "Busca prepublicaciones en arXiv y devuelve sus metadatos.",
    },
    "reason": {
        "en": "Use a dedicated reasoning model call for hard reasoning tasks.",
        "zh": "调用专门的推理模型处理高难度推理任务。",
        "es": "Usa un modelo de razonamiento específico para tareas complejas.",
    },
    "web_search": {
        "en": "Search the web and return sourced results.",
        "zh": "联网搜索并返回带来源的结果。",
        "es": "Busca en la web y devuelve resultados con sus fuentes.",
    },
    "imagegen": {
        "en": "Generate images from a text prompt with the configured model.",
        "zh": "用已配置的模型，根据文字描述生成图片。",
        "es": "Genera imágenes a partir de una descripción con el modelo configurado.",
    },
    "videogen": {
        "en": "Generate short videos from a text prompt with the configured model.",
        "zh": "用已配置的模型，根据文字描述生成短视频。",
        "es": "Genera vídeos cortos a partir de una descripción con el modelo configurado.",
    },
}
...
def capability_description_i18n(name: str, fallback: str = "") -> dict[str, str]:
    ...
    if values:
        return dict(values)
    return {"en": fallback, "zh": fallback, "es": fallback}
