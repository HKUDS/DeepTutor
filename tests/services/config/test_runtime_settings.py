...
def test_auth_private_login_hosts_normalization_and_overrides(tmp_path: Path) -> None:
    service = RuntimeSettingsService(tmp_path / "settings")
    ...
    assert env_loaded["private_login_hosts"] == ["100.101.207.44", "10.0.0.2", "10.0.0.3"]
