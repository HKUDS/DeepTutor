  ...
  return (
    <div className="h-screen flex bg-slate-50 dark:bg-background">
          ...
          <div className="p-3 border-t border-slate-200">
            ...
            <div className="mb-3">
              ...
              <select
                ...
                className="w-full px-2 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-sm dark:text-slate-200 outline-none"
              >
                {kbs.map((kb) => (
      ...
      <div className="flex-1 flex flex-col">
        {/* Header */}
        <div className="h-14 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center px-4 gap-4">
          {!showSidebar && (
            <button
          ...
          <div className="ml-auto flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
            ...
            {enableWebSearch && (
              <span className="px-2 py-1 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 rounded-full text-xs flex items-center gap-1">
