    ...
    <div className="animate-fade-in h-screen overflow-y-auto p-8">
                    ...
                    {(() => {
                      ...
                      if (progress) {
                        if (progress.stage === 'completed') {
                          ...
                          return (
                            <span className="text-red-600 dark:text-red-400 font-bold">错误</span>
                          )
                        } else {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 ">
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md p-6 animate-in zoom-in-95">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">新建知识库</h3>
              <button
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                >
                  {uploading ? <Loader2 className="w-4 h-4 animate-spin" /> : '创建并初始化'}
                </button>
              </div>
            </form>
          </div>
      ...
      {uploadModalOpen && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md p-6 animate-in zoom-in-95">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">上传文档</h3>
              <button
            ...
            <form onSubmit={handleUpload} className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                >
                  {uploading ? <Loader2 className="w-4 h-4 animate-spin" /> : '上传'}
                </button>
              </div>
            </form>
          </div>
