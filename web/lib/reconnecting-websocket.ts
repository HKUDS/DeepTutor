...
export class ReconnectingWebSocket {
  ...
  constructor(
    ...
    this.staleConnectingMs = options.staleConnectingMs ?? DEFAULT_STALE_CONNECTING_MS
  }
  ...
  private scheduleRetry(): void {
    ...
    const delayMs = reconnectDelayMs(this.retryAttempt, this.baseRetryMs, this.maxRetryMs)
    this.retryAttempt += 1
