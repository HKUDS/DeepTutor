export const translations = {
  en: {
    ...
    'Invalid response: missing marked_text field': 'Invalid response: missing marked_text field',
    'Invalid response: missing edited_text field': 'Invalid response: missing edited_text field',
    ...
    'Backend response took too long, please check': 'Backend response took too long, please check',
    ...
    'Select a question task to view details': 'Select a question task to view details',
    ...
    'Generate questions based on reference paper': 'Generate questions based on reference paper',
  ...
  zh: {
    ...
    'Base URL': '基础 URL',
    'My Provider': '我的提供方',
    'Failed to connect to backend for model fetching.': '连接后端失败，无法获取模型列表。',
    ...
    'After generation, the narration script will appear here.':
      '生成完成后，旁白文稿会显示在这里。',
    'Key Points': '要点',
    'After generation, 3-5 key points will be listed here.': '生成完成后，这里会列出 3–5 个要点。',
    'Podcast Audio': '播客音频',
    'Your browser does not support the audio element.': '您的浏览器不支持音频播放。',
    'TTS not configured, script generation only.': '未配置 TTS，仅生成文稿。',
    'After generation, you can play the podcast audio here.':
      '生成完成后，您可以在这里播放播客音频。',
    'PDF export failed, please try again. Check console for error details.':
    ...
    Process: '过程',
    Report: '报告',
    'Enter a topic in the sidebar to start deep research.': '在左侧面板输入主题即可开始深度研究。',
    Generate: '生成',
    Retrieving: '检索中',
    Uploading: '上传中',
    Parsing: '解析中',
