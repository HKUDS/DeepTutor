...
export default function FilePreviewDrawer({
  ...
  return (
    <div
      ...
      className={`fixed right-0 top-0 z-[90] flex h-[100dvh] w-full flex-col border-l border-[var(--border)] bg-[var(--card)] shadow-2xl transition-transform ease-out sm:w-[min(560px,92vw)] ${
