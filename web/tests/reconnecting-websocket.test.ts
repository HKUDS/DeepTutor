...
import { ReconnectingWebSocket, reconnectDelayMs } from '../lib/reconnecting-websocket'
...
test('partner composer restores focus after streaming and page return', () => {
  ...
  assert.match(source, /document\.addEventListener\("visibilitychange", restoreFocus\)/)
})
